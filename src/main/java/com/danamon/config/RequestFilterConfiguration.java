    ...
    private void logRequestHeader(ContentCachingRequestWrapper request, String prefix) throws IOException {
        ...
        Collections.list(request.getHeaderNames()).forEach((headerName) -> {
            Collections.list(request.getHeaders(headerName)).forEach((headerValue) -> {
                if(headerName.equals("authorization") || headerName.equalsIgnoreCase("uid") || headerName.equalsIgnoreCase("secureId")) log.info("{} {}: {}", new Object[]{prefix, headerName, headerValue});
            });
        });
