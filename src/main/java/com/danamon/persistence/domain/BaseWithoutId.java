...
@DynamicUpdate
public abstract class BaseWithoutId implements Serializable {

    private static final long serialVersionUID = -7369920601847524273L;

    protected BaseWithoutId() { }
    ...
    public void setCreateBaseDate(String by, Date date) {
        this.createdBy = by;
    ...
    public void setUpdateBaseData(String by, Date date) {
        this.modifiedBy = by;
